...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 订单管理 <span
        class="c-gray en">&gt;</span> 订单流水 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px"
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        ...
        <div class="dataTables_wrapper no-footer">
            ...
            <table class="table table-border table-bordered table-hover table-bg table-sort dataTable no-footer" 
             id="EP_table" role="grid" url="<%=basePath%>/admin/adminOrderSelect" current_page="1">
                <thead>
					<tr class="text-c">
						<th field="orderId" width="40">ID</th>
						<th field="tripsName" width="150">所属车次</th>
						<th field="ticketSeattype" width="100">类型</th>
						<th field="orderPrice" width="100">订单价格</th>
						<th field="orderQuantity" width="100">订单数量</th>
